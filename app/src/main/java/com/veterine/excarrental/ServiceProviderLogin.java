...
public class ServiceProviderLogin extends AppCompatActivity {
    ...
    String insertUrl = "http://192.168.43.240/excarental/service_provider_login.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final RequestQueue requestQueue = Volley.newRequestQueue(ServiceProviderLogin.this);
                StringRequest stringRequest = new StringRequest(Request.Method.POST, insertUrl, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.equals("validUser")){
                            ...
                            Toast.makeText(ServiceProviderLogin.this, "Login Successful", Toast.LENGTH_SHORT).show();

                            Intent intent = new Intent(getApplicationContext(), ServiceProviderAccount.class);
                            startActivity(intent);
                            finish();
                        }
                        else {

                            Toast.makeText(ServiceProviderLogin.this, response, Toast.LENGTH_LONG).show();
