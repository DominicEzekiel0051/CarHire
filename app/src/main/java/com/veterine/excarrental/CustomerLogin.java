...
public class CustomerLogin extends AppCompatActivity {
    ...
    String insertUrl = "http://192.168.43.240/excarental/customer_login.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final RequestQueue requestQueue = Volley.newRequestQueue(CustomerLogin.this);
                StringRequest stringRequest = new StringRequest(Request.Method.POST, insertUrl, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.equals("validUser")){
                            ...
                            Intent intent = new Intent(getApplicationContext(), CustomerAccount.class);
                            startActivity(intent);
                            finish();
                        }
                        else {

                            Toast.makeText(CustomerLogin.this, response, Toast.LENGTH_LONG).show();
